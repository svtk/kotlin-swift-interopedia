...
<table>
  ...
  <tr><td><a href="/docs/common/Exceptions%20and%20Errors.md">Exceptions and errors</a></td><td>Exceptions declared with @Throws are represented with NSError and must be handled. Not declared exceptions will cause a program termination.</td></tr>
</table>
